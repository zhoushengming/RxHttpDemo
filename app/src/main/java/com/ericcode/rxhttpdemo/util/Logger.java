...
public class Logger {
    ...
    public static void i_tag(String tag, String format, Object... args) {
        if (enable && LOG_I) {
            String message = buildMessage(format, args);
            tag = formatLength(preTag + tag, tagLength);
    ...
    public static void w_tag(String tag, String format, Object... args) {
        if (enable && LOG_W) {
            String message = buildMessage(format, args);
            tag = formatLength(preTag + tag, tagLength);
    ...
    public static void printCaller(String tag) {
        ...
        try {
            ...
            if (tag == null) {
                Log.i(preTag, infoBuffer.toString());
            } else {
